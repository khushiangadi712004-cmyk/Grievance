...
<button class="role" onclick="window.location.href='student_login.php'"><p>
</div>
...
<h3>Staff</h3>
<p>Submit and track your complaints</p>
<a href="staff_login.php" class="signin">Sign In →</a>
<button class="role" onclick="window.location.href='staff_login.php'"><p>
</div>
...
<a href="hod_login.php" class="signin">Sign In →</a>
<button class="role" onclick="window.location.href='staff_login.php'"><p>
</div>
...
<a href="../admin/admin_login.php" class="signin">Sign In →</a>
 <button class="role" onclick="window.location.href='../admin/admin_login.php'"><p>
</div>
